...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void CreateMahasiswa(kos data){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(tb_bank_id, data.get_id());
        values.put(tb_bank_nama, data.get_nama());
        values.put(tb_bank_antrian, data.get_kelas());
        db.insert(tb_bank, null, values);
        db.close();
    }


    public List<kos> ReadMahasiswa() {
        List<kos> listMhs = new ArrayList<kos>();
    ...
    public int UpdateMahasiswa (kos data){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(tb_bank_nama, data.get_nama());
        values.put(tb_bank_antrian, data.get_kelas());
    ...
    public void DeleteMahasiswa(kos data){
        SQLiteDatabase db = this.getWritableDatabase();
